  ...
  static Map<String, Integer> sort(Map<String, Integer> wordCounts, int popularWordCount) {
    ...
    return wordCounts.entrySet().stream()
          ...
          .collect(Collectors.toMap(
                  Map.Entry::getKey,
                  Map.Entry::getValue,
                  (key1, key2) -> key1 /* handle duplicated keys if it happens since this is required by toMap method */,
                  LinkedHashMap::new)); /* using LinkedHashMap to guarantee the correct order of elements in the map */
  }
